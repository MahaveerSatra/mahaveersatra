...
const DesignProcessSection: React.FC = () => {
  const steps = [
    ...
    },
    {
      ...
      note: "Making math do cool stuff"
    },
    {
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-blue mb-6 text-center">
            This is how you can get your design and development <HighlightedText color="green">right</HighlightedText>
          </h2>
