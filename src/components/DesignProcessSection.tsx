  ...
  const steps = [
    {
      ...
      color: "bg-gradient-to-br from-primary-blue to-primary-blue/80"
    },
    {
      ...
      color: "bg-gradient-to-br from-accent-amber to-accent-amber/80"
    },
    {
      ...
      color: "bg-gradient-to-br from-secondary-green to-secondary-green/80"
    },
    {
    ...
    <section className="py-20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="h-1 w-32 bg-accent-amber mx-auto mb-10"></div>
          ...
          <p className="text-slate-500 italic text-center mb-12">"We don't just cross our fingers and hope for the best – unless it's for good weather at the company picnic."</p>
          ...
          <div className="space-y-12 mt-16">
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col md:flex-row gap-6 items-center group">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border-l-4 border-accent-amber flex-1 hover:shadow-md transition-all duration-300 mt-4 md:mt-0">
          ...
          <div className="mt-16 text-center">
            <div className="bg-white p-8 rounded-xl shadow-md border-t-4 border-accent-amber hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-slate-500 italic mb-6">"Because the only thing we like wasting is bad jokes, not your development time."</p>
              <Button className="bg-accent-amber hover:bg-accent-amber/90 text-primary-blue font-medium px-6 py-6 rounded-full shadow-sm">
