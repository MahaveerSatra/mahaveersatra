...
const HeroSection: React.FC = () => {
  return (
    <section className="pt-36 pb-20 bg-gradient-to-b from-blue-50 to-indigo-50 min-h-[80vh] flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="bg-white/90 py-16 px-6 rounded-xl shadow-lg mb-10 backdrop-blur-sm border border-slate-100 transform transition-all duration-500 hover:shadow-xl">
            <div className="mb-8 animate-fade-in">
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                <span className="text-blue-600">Fast-Track Success</span>
              </h2>
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                with <span className="text-teal-500">Insightful Simulations</span>
              </h2>
              <div className="h-1 w-32 bg-amber-400 mx-auto mb-6"></div>
              <p className="text-sm text-blue-400 italic mb-2">— because why wait for problems when you can simulate them? —</p>
            </div>
            ...
            <Button className="bg-amber-400 hover:bg-amber-500 text-blue-700 font-medium px-8 py-2.5 rounded-full shadow-md hover:shadow-lg transition-all duration-300 mx-auto transform hover:scale-105">
