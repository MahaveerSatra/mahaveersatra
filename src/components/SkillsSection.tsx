...
const SkillsSection: React.FC = () => {
  const skills: Skill[] = [
    ...
    { name: "Industrial Automation", value: 90, category: "technical" },
  ...
  // Using a professional two-color scheme
  ...
  // Adventure cards for visual appeal with consistent coloring
  const adventureCards = [
    {
      icon: <Bike className="h-12 w-12 text-mathworks" />,
      title: "Cycling Adventures",
      description: "Exploring new trails and roads on two wheels.",
      bgColor: "bg-gray-50"
    },
    {
      icon: <Ship className="h-12 w-12 text-navy" />,
      title: "Kayaking Expeditions",
      description: "Navigating waterways and enjoying the serenity of lakes.",
      bgColor: "bg-gray-50"
    },
    {
      icon: <Mountain className="h-12 w-12 text-mathworks" />,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
            <h3 className="text-2xl font-semibold text-navy mb-6 flex items-center">
              <Cpu className="mr-2 h-6 w-6 text-mathworks" /> Technical Skills
            </h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
            <h3 className="text-2xl font-semibold text-navy mb-6 flex items-center">
              <TrendingUp className="mr-2 h-6 w-6 text-navy" /> Business Skills
            </h3>
            <div className="space-y-6">
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {adventureCards.map((card, index) => (
              <div key={index} className={`${card.bgColor} rounded-xl p-6 shadow-md border border-gray-100 transform hover:scale-105 transition-all duration-300`}>
